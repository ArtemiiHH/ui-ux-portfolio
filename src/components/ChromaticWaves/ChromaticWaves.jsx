...
import styles from "./ChromaticWaves.module.css";
...
export default function ChromaticWaves({
  ...
  useEffect(() => {
    ...
    const perlinProgram = new Program(gl, {
      ...
      uniforms: {
        ...
        uSpeed: { value: animated ? mapSpeedUiToShader(speed) : 0 },
        uValue: { value: 1 },
  ...
  useEffect(() => {
    ...
    perlin.uniforms.uSpeed.value = animated ? mapSpeedUiToShader(speed) : 0;
